...
import { ActivationDto } from 'src/app/config/security/shared/model/Activation.model';


@Component({
  selector: 'app-activation-doctor',
  templateUrl: './activation-doctor.component.html',
  styleUrls: ['./activation-doctor.component.css']
})
export class ActivationDoctorComponent implements OnInit {
    ...
    forget() {
        this.router.navigate(['/doctor/changePassword']);
    }
