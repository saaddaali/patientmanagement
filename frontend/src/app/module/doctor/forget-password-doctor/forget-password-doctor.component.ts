...
@Component({
    selector: 'app-forget-password-doctor',
    templateUrl: './forget-password-doctor.component.html',
    styleUrls: ['./forget-password-doctor.component.css'],
})
export class ForgetPasswordDoctorComponent {
