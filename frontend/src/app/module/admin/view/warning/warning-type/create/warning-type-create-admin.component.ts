...
@Component({
  selector: 'app-warning-type-create-admin',
  templateUrl: './warning-type-create-admin.component.html'
})
export class WarningTypeCreateAdminComponent  implements OnInit {
