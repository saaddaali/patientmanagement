...
@Component({
  selector: 'app-warning-patient-create-admin',
  templateUrl: './warning-patient-create-admin.component.html'
})
export class WarningPatientCreateAdminComponent  implements OnInit {
