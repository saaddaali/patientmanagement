...
@Component({
  selector: 'app-warning-patient-list-admin',
  templateUrl: './warning-patient-list-admin.component.html'
})
export class WarningPatientListAdminComponent implements OnInit {
