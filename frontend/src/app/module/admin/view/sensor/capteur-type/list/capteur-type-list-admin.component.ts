...
@Component({
  selector: 'app-capteur-type-list-admin',
  templateUrl: './capteur-type-list-admin.component.html'
})
export class CapteurTypeListAdminComponent implements OnInit {

    protected fileName = 'CapteurType';
    ...
    constructor( private service: CapteurTypeAdminService  , @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<CapteurTypeDto>();
    ...
    public async edit(dto: CapteurTypeDto) {
    ...
    public async view(dto: CapteurTypeDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: CapteurTypeDto) {
    ...
    public async duplicate(dto: CapteurTypeDto) {
    ...
    public exportPdf(dto: CapteurTypeDto): void {
...
// add
	...
	public initDuplicate(res: CapteurTypeDto) {
	}
    ...
    get items(): Array<CapteurTypeDto> {
        return this.service.items;
    }

    set items(value: Array<CapteurTypeDto>) {
        this.service.items = value;
    }

    get selections(): Array<CapteurTypeDto> {
        return this.service.selections;
    }

    set selections(value: Array<CapteurTypeDto>) {
        this.service.selections = value;
    }

    get item(): CapteurTypeDto {
        return this.service.item;
    }

    set item(value: CapteurTypeDto) {
    ...
    get criteria(): CapteurTypeCriteria {
        return this.service.criteria;
    }

    set criteria(value: CapteurTypeCriteria) {
