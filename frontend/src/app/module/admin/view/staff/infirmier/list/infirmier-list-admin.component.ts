...
export class InfirmierListAdminComponent implements OnInit {
    ...
    constructor( private service: InfirmierAdminService  , private specializationService: SpecializationAdminService, @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<InfirmierDto>();
    ...
    public async edit(dto: InfirmierDto) {
    ...
    public async view(dto: InfirmierDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: InfirmierDto) {
    ...
    public async duplicate(dto: InfirmierDto) {
    ...
    public exportPdf(dto: InfirmierDto): void {
...
// add
    ...
    public initCol() {
        this.cols = [
            {field: 'specialization?.libelle', header: 'Specialization'},
    ...
    public async loadSpecialization(){
        this.specializationService.findAllOptimized().subscribe(specializations => this.specializations = specializations, error => console.log(error))
    }


	public initDuplicate(res: InfirmierDto) {
	}
        ...
        this.service.findByCriteria(this.criteria).subscribe(
            (allItems) =>{
                this.exportData = allItems.map(e => {
					return {
						'Specialization': e.specialization?.libelle ,
            ...
            this.criteriaData = [{
            //'Specialization': this.criteria.specialization?.libelle ? this.criteria.specialization?.libelle : environment.emptyForExport ,
    ...
    get selections(): Array<InfirmierDto> {
        return this.service.selections;
    }

    set selections(value: Array<InfirmierDto>) {
