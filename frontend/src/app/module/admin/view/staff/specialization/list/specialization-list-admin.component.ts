...
@Component({
  selector: 'app-specialization-list-admin',
  templateUrl: './specialization-list-admin.component.html'
})
export class SpecializationListAdminComponent implements OnInit {

    protected fileName = 'Specialization';
    ...
    constructor( private service: SpecializationAdminService  , @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<SpecializationDto>();
    ...
    public async edit(dto: SpecializationDto) {
    ...
    public async view(dto: SpecializationDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async openCreate() {
        this.item = new SpecializationDto();
    ...
    public async delete(dto: SpecializationDto) {
    ...
    public async duplicate(dto: SpecializationDto) {
    ...
    public exportPdf(dto: SpecializationDto): void {
...
// add
	...
	public initDuplicate(res: SpecializationDto) {
	}
    ...
    get selections(): Array<SpecializationDto> {
        return this.service.selections;
    }

    set selections(value: Array<SpecializationDto>) {
