...
@Component({
  selector: 'app-specialization-edit-admin',
  templateUrl: './specialization-edit-admin.component.html'
})
export class SpecializationEditAdminComponent implements OnInit {
