...
export class DoctorListAdminComponent implements OnInit {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<DoctorDto>();
    ...
    public async edit(dto: DoctorDto) {
    ...
    public async view(dto: DoctorDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: DoctorDto) {
    ...
    public async duplicate(dto: DoctorDto) {
    ...
    public exportPdf(dto: DoctorDto): void {
...
// add
	...
	public initDuplicate(res: DoctorDto) {
	}
    ...
    get selections(): Array<DoctorDto> {
        return this.service.selections;
    }

    set selections(value: Array<DoctorDto>) {
