...
export class GenderListAdminComponent implements OnInit {

    protected fileName = 'Gender';
    ...
    constructor( private service: GenderAdminService  , @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<GenderDto>();
    ...
    public async edit(dto: GenderDto) {
    ...
    public async view(dto: GenderDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: GenderDto) {
    ...
    public async duplicate(dto: GenderDto) {
    ...
    public exportPdf(dto: GenderDto): void {
...
// add
    ...
    get selections(): Array<GenderDto> {
        return this.service.selections;
    }

    set selections(value: Array<GenderDto>) {
