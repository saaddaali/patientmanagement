...
@Component({
  selector: 'app-infirmier-patient-edit-admin',
  templateUrl: './infirmier-patient-edit-admin.component.html'
})
export class InfirmierPatientEditAdminComponent implements OnInit {
