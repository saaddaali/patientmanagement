...
@Component({
  selector: 'app-infirmier-patient-list-admin',
  templateUrl: './infirmier-patient-list-admin.component.html'
})
export class InfirmierPatientListAdminComponent implements OnInit {
