...
@Component({
  selector: 'app-safe-zone-view-admin',
  templateUrl: './safe-zone-view-admin.component.html'
})
export class SafeZoneViewAdminComponent implements OnInit {
    ...
    constructor(private service: SafeZoneAdminService, private patientService: PatientAdminService){
