...
import {LocalisationAdminService} from 'src/app/shared/service/admin/localisation/LocalisationAdmin.service';
...
@Component({
  selector: 'app-localisation-create-admin',
  templateUrl: './localisation-create-admin.component.html'
})
export class LocalisationCreateAdminComponent  implements OnInit {
	...
	constructor(private service: LocalisationAdminService , private capteurService: CapteurAdminService, private patientService: PatientAdminService, @Inject(PLATFORM_ID) private platformId? ) {
