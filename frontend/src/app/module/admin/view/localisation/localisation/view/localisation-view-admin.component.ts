...
@Component({
  selector: 'app-localisation-view-admin',
  templateUrl: './localisation-view-admin.component.html'
})
export class LocalisationViewAdminComponent implements OnInit {
    ...
    constructor(private service: LocalisationAdminService, private capteurService: CapteurAdminService, private patientService: PatientAdminService){
