...
@Component({
  selector: 'app-login-infirmier',
  templateUrl: './login-infirmier.component.html',
  styleUrls: ['./login-infirmier.component.css']
})
export class LoginInfirmierComponent implements OnInit {
