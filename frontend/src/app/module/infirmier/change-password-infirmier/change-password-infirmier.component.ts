...
@Component({
  selector: 'app-change-password-infirmier',
  templateUrl: './change-password-infirmier.component.html',
  styleUrls: ['./change-password-infirmier.component.css']
})
export class ChangePasswordInfirmierComponent implements OnInit {
    ...
    forgetPassword() {
        this.router.navigate(['/infirmier/forget-password'])
    }
