...
@Component({
  selector: 'app-activation-infirmier',
  templateUrl: './activation-infirmier.component.html',
  styleUrls: ['./activation-infirmier.component.css']
})
export class ActivationInfirmierComponent implements OnInit {
    ...
    register() {
        this.router.navigate(['/infirmier/register']);
    }

    forget() {
        this.router.navigate(['/infirmier/changePassword']);
    }
