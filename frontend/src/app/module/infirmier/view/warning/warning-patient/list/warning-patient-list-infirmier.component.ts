...
@Component({
  selector: 'app-warning-patient-list-infirmier',
  templateUrl: './warning-patient-list-infirmier.component.html'
})
export class WarningPatientListInfirmierComponent implements OnInit {

    protected fileName = 'WarningPatient';
    ...
    warningTypes: Array<WarningTypeDto>;
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<WarningPatientDto>();
    ...
    public async edit(dto: WarningPatientDto) {
    ...
    public async view(dto: WarningPatientDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: WarningPatientDto) {
    ...
    public async duplicate(dto: WarningPatientDto) {
    ...
    public exportPdf(dto: WarningPatientDto): void {
...
// add
    ...
    public initCol() {
        this.cols = [
            ...
            {field: 'warningType?.libelle', header: 'Warning type'},
            {field: 'dateWarning', header: 'Date warning'},
        ];
    }
    ...
    public async loadWarningType(){
        this.warningTypeService.findAllOptimized().subscribe(warningTypes => this.warningTypes = warningTypes, error => console.log(error))
    }


	public initDuplicate(res: WarningPatientDto) {
	}
    ...
    public prepareColumnExport(): void {
        this.service.findByCriteria(this.criteria).subscribe(
            (allItems) =>{
                this.exportData = allItems.map(e => {
					return {
						...
						'Message': e.message ,
						'Warning type': e.warningType?.libelle ,
						'Date warning': this.datePipe.transform(e.dateWarning , 'dd/MM/yyyy hh:mm'),
					}
				});
            ...
            //'Warning type': this.criteria.warningType?.libelle ? this.criteria.warningType?.libelle : environment.emptyForExport ,
                'Date warning Min': this.criteria.dateWarningFrom ? this.datePipe.transform(this.criteria.dateWarningFrom , this.dateFormat) : environment.emptyForExport ,
                'Date warning Max': this.criteria.dateWarningTo ? this.datePipe.transform(this.criteria.dateWarningTo , this.dateFormat) : environment.emptyForExport ,
            }];
			}
    ...
    get selections(): Array<WarningPatientDto> {
        return this.service.selections;
    }

    set selections(value: Array<WarningPatientDto>) {
