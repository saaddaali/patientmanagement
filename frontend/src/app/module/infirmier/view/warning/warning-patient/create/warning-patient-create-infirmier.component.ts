...
@Component({
  selector: 'app-warning-patient-create-infirmier',
  templateUrl: './warning-patient-create-infirmier.component.html'
})
export class WarningPatientCreateInfirmierComponent  implements OnInit {
