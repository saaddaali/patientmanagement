...
@Component({
  selector: 'app-safe-zone-view-infirmier',
  templateUrl: './safe-zone-view-infirmier.component.html'
})
export class SafeZoneViewInfirmierComponent implements OnInit {
    ...
    constructor(private service: SafeZoneInfirmierService, private patientService: PatientInfirmierService){
