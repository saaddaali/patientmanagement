...
@Component({
  selector: 'app-safe-zone-create-infirmier',
  templateUrl: './safe-zone-create-infirmier.component.html'
})
export class SafeZoneCreateInfirmierComponent  implements OnInit {
