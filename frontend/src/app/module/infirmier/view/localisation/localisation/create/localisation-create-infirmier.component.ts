...
@Component({
  selector: 'app-localisation-create-infirmier',
  templateUrl: './localisation-create-infirmier.component.html'
})
export class LocalisationCreateInfirmierComponent  implements OnInit {
