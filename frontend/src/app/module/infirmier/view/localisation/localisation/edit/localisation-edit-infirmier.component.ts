...
@Component({
  selector: 'app-localisation-edit-infirmier',
  templateUrl: './localisation-edit-infirmier.component.html'
})
export class LocalisationEditInfirmierComponent implements OnInit {
