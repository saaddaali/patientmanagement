...
@Component({
  selector: 'app-register-infirmier',
  templateUrl: './register-infirmier.component.html',
  styleUrls: ['./register-infirmier.component.css']
})
export class RegisterInfirmierComponent implements OnInit {
    ...
    submit() {
        ...
        if (this.registerDto.phone && this.registerDto.firstName && this.registerDto.lastName &&
            ...
            this.authService.registerInfirmier();
