...
@Component({
    selector: 'app-forget-password-infirmier',
    templateUrl: './forget-password-infirmier.component.html',
    styleUrls: ['./forget-password-infirmier.component.css'],
})
export class ForgetPasswordInfirmierComponent {
