...
export class AuthService {
    ...
    */
    ...
    public registerDoctor() {
        this.register(this.registerUrl + 'doctor', 'ROLE_DOCTOR', '/doctor/activation')
    }

    public registerInfirmier() {
        this.register(this.registerUrl + 'infirmier', 'ROLE_INFIRMIER', '/infirmier/activation')
    }
            ...
            .pipe(
                map(resp => {
                    if (this.user.roleUsers[0].role.authority === 'ADMIN') {
                        ...
                        else if (this.user.roleUsers[0].role.authority === 'DOCTOR') {
                        this.router.navigate(['/doctor/login']);
                        }
                        else if (this.user.roleUsers[0].role.authority === 'INFIRMIER') {
                        this.router.navigate(['/infirmier/login']);
                        }
                    return resp;
                }),
