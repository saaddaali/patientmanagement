...
import ma.zyn.app.service.impl.infirmier.staff.SpecializationInfirmierServiceImpl;
...
@SpringBootTest
class SpecializationInfirmierServiceImplTest {

    @Mock
    private SpecializationDao repository;
    private AutoCloseable autoCloseable;
    private SpecializationInfirmierServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new SpecializationInfirmierServiceImpl(repository);
    }
