package ma.zyn.app.unit.ws.facade.infirmier.warning;

import ma.zyn.app.bean.core.warning.WarningPatient;
import ma.zyn.app.service.impl.infirmier.warning.WarningPatientInfirmierServiceImpl;
import ma.zyn.app.ws.facade.infirmier.warning.WarningPatientRestInfirmier;
...
public class WarningPatientRestInfirmierTest {

    private MockMvc mockMvc;

    @Mock
    private WarningPatientInfirmierServiceImpl service;
    @Mock
    private WarningPatientConverter converter;

    @InjectMocks
    private WarningPatientRestInfirmier controller;
