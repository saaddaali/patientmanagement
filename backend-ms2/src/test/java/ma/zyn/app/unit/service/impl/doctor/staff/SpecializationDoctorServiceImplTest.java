...
import ma.zyn.app.service.impl.doctor.staff.SpecializationDoctorServiceImpl;
...
@SpringBootTest
class SpecializationDoctorServiceImplTest {

    @Mock
    private SpecializationDao repository;
    private AutoCloseable autoCloseable;
    private SpecializationDoctorServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new SpecializationDoctorServiceImpl(repository);
    }
