package ma.zyn.app.unit.service.impl.doctor.patient;

import ma.zyn.app.bean.core.patient.Gender;
import ma.zyn.app.dao.facade.core.patient.GenderDao;
import ma.zyn.app.service.impl.doctor.patient.GenderDoctorServiceImpl;
...
@SpringBootTest
class GenderDoctorServiceImplTest {

    @Mock
    private GenderDao repository;
    private AutoCloseable autoCloseable;
    private GenderDoctorServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new GenderDoctorServiceImpl(repository);
    }
