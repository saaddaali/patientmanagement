package ma.zyn.app.unit.service.impl.doctor.warning;

import ma.zyn.app.bean.core.warning.WarningType;
import ma.zyn.app.dao.facade.core.warning.WarningTypeDao;
import ma.zyn.app.service.impl.doctor.warning.WarningTypeDoctorServiceImpl;
...
@SpringBootTest
class WarningTypeDoctorServiceImplTest {

    @Mock
    private WarningTypeDao repository;
    private AutoCloseable autoCloseable;
    private WarningTypeDoctorServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new WarningTypeDoctorServiceImpl(repository);
    }
