package ma.zyn.app.unit.ws.facade.doctor.healthcare;

import ma.zyn.app.bean.core.healthcare.InfirmierPatient;
import ma.zyn.app.service.impl.doctor.healthcare.InfirmierPatientDoctorServiceImpl;
import ma.zyn.app.ws.facade.doctor.healthcare.InfirmierPatientRestDoctor;
...
public class InfirmierPatientRestDoctorTest {

    private MockMvc mockMvc;

    @Mock
    private InfirmierPatientDoctorServiceImpl service;
    @Mock
    private InfirmierPatientConverter converter;

    @InjectMocks
    private InfirmierPatientRestDoctor controller;
