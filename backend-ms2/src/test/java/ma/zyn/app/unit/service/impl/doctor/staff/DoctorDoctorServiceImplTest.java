...
import ma.zyn.app.service.impl.doctor.staff.DoctorDoctorServiceImpl;
...
@SpringBootTest
class DoctorDoctorServiceImplTest {

    @Mock
    private DoctorDao repository;
    private AutoCloseable autoCloseable;
    private DoctorDoctorServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new DoctorDoctorServiceImpl(repository);
    }
