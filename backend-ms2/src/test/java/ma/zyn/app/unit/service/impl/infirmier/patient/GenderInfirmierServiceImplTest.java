...
import ma.zyn.app.service.impl.infirmier.patient.GenderInfirmierServiceImpl;
...
@SpringBootTest
class GenderInfirmierServiceImplTest {

    @Mock
    private GenderDao repository;
    private AutoCloseable autoCloseable;
    private GenderInfirmierServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new GenderInfirmierServiceImpl(repository);
    }
