package ma.zyn.app.unit.service.impl.doctor.healthcare;
...
@SpringBootTest
class InfirmierPatientDoctorServiceImplTest {

    @Mock
    private InfirmierPatientDao repository;
    private AutoCloseable autoCloseable;
    private InfirmierPatientDoctorServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new InfirmierPatientDoctorServiceImpl(repository);
    }
