package  ma.zyn.app.ws.facade.admin.healthcare;
...
@RestController
@RequestMapping("/api/admin/infirmierPatient/")
public class InfirmierPatientRestAdmin {
    ...
    @Operation(summary = "find by infirmier id")
    @GetMapping("infirmier/id/{id}")
    public List<InfirmierPatientDto> findByInfirmierId(@PathVariable Long id){
        return findDtos(service.findByInfirmierId(id));
    }
    @Operation(summary = "delete by infirmier id")
    @DeleteMapping("infirmier/id/{id}")
    public int deleteByInfirmierId(@PathVariable Long id){
        return service.deleteByInfirmierId(id);
    }
   ...
   public InfirmierPatientRestAdmin(InfirmierPatientAdminService service, InfirmierPatientConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final InfirmierPatientAdminService service;
