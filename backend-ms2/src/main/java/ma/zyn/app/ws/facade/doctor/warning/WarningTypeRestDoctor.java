...
@RestController
@RequestMapping("/api/doctor/warningType/")
public class WarningTypeRestDoctor {
   ...
   public WarningTypeRestDoctor(WarningTypeAdminService service, WarningTypeConverter converter){
