...
@RestController
@RequestMapping("/api/doctor/infirmier/")
public class InfirmierRestDoctor {
   ...
   public InfirmierRestDoctor(InfirmierDoctorService service, InfirmierConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final InfirmierDoctorService service;
