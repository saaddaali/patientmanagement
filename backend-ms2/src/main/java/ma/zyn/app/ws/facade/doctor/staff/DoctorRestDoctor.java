...
public class DoctorRestDoctor {
    ...
    @Operation(summary = "find by specialization id")
    @GetMapping("specialization/id/{id}")
    public List<DoctorDto> findBySpecializationId(@PathVariable Long id){
        return findDtos(service.findBySpecializationId(id));
    }
    @Operation(summary = "delete by specialization id")
    @DeleteMapping("specialization/id/{id}")
    public int deleteBySpecializationId(@PathVariable Long id){
        return service.deleteBySpecializationId(id);
    }
   ...
   public DoctorRestDoctor(DoctorAdminService service, DoctorConverter converter){
