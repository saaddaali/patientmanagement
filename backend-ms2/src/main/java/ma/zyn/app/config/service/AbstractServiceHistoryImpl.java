...
import ma.zyn.app.config.dto.AuditEntityDto;
import ma.zyn.app.config.exception.EntityNotFoundException;
import ma.zyn.app.config.bean.BaseEntity;
import ma.zyn.app.config.history.HistCriteria;
import ma.zyn.app.config.repository.AbstractHistoryRepository;
import ma.zyn.app.config.security.bean.User;
import ma.zyn.app.config.security.service.facade.UserService;
import ma.zyn.app.config.specification.AbstractHistorySpecification;
