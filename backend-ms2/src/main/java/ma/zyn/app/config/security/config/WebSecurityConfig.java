...
import ma.zyn.app.config.security.jwt.AuthEntryPointJwt;
import ma.zyn.app.config.security.jwt.AuthTokenFilter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.csrf(csrf -> csrf.disable())
                ...
                .authorizeHttpRequests(auth -> auth
                                ...
                                .requestMatchers("/api/infirmier/login").permitAll()
