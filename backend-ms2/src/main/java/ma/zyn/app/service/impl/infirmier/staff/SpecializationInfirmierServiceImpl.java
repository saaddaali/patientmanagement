...
import java.util.List;
@Service
public class SpecializationInfirmierServiceImpl implements SpecializationInfirmierService {
    ...
    public SpecializationInfirmierServiceImpl(SpecializationDao dao) {
        this.dao = dao;
    }
