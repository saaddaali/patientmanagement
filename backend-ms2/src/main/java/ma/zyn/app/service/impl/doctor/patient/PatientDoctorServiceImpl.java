package ma.zyn.app.service.impl.doctor.patient;
...
import ma.zyn.app.service.facade.doctor.patient.GenderDoctorService ;
import ma.zyn.app.service.facade.doctor.staff.DoctorDoctorService ;
...
public class PatientDoctorServiceImpl implements PatientDoctorService {
    ...
    @Autowired
    private InfirmierDoctorService infirmierService ;
    @Autowired
    private InfirmierPatientDoctorService infirmierPatientService ;
    @Autowired
    private GenderDoctorService genderService ;
    @Autowired
    private DoctorDoctorService doctorService ;
    @Autowired
    private WarningPatientDoctorService warningPatientService ;
    @Autowired
    private WarningTypeDoctorService warningTypeService ;

    public PatientDoctorServiceImpl(PatientDao dao) {
        this.dao = dao;
    }
