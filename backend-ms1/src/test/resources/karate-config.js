function fn() {
    ...
    config.genderUrl = config.adminUri + 'gender/';
    config.localisationUrl = config.adminUri + 'localisation/';
    config.patientUrl = config.adminUri + 'patient/';
    config.safeZoneUrl = config.adminUri + 'safeZone/';
    config.capteurTypeUrl = config.adminUri + 'capteurType/';
    config.capteurUrl = config.adminUri + 'capteur/';
    config.infirmierUrl = config.adminUri + 'infirmier/';
    config.specializationUrl = config.adminUri + 'specialization/';
    config.infirmierPatientUrl = config.adminUri + 'infirmierPatient/';
    config.doctorUrl = config.adminUri + 'doctor/';
    config.warningPatientUrl = config.adminUri + 'warningPatient/';
    config.warningTypeUrl = config.adminUri + 'warningType/';
