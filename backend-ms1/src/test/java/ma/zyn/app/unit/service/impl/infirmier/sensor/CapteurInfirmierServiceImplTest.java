...
import ma.zyn.app.service.impl.infirmier.sensor.CapteurInfirmierServiceImpl;
...
@SpringBootTest
class CapteurInfirmierServiceImplTest {

    @Mock
    private CapteurDao repository;
    private AutoCloseable autoCloseable;
    private CapteurInfirmierServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new CapteurInfirmierServiceImpl(repository);
    }
