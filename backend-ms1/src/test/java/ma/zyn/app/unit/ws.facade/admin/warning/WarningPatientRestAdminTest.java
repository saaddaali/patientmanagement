...
import ma.zyn.app.ws.facade.admin.warning.WarningPatientRestAdmin;
...
public class WarningPatientRestAdminTest {

    private MockMvc mockMvc;

    @Mock
    private WarningPatientAdminServiceImpl service;
    @Mock
    private WarningPatientConverter converter;

    @InjectMocks
    private WarningPatientRestAdmin controller;
