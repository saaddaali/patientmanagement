...
import ma.zyn.app.service.impl.doctor.sensor.CapteurTypeDoctorServiceImpl;
...
@SpringBootTest
class CapteurTypeDoctorServiceImplTest {

    @Mock
    private CapteurTypeDao repository;
    private AutoCloseable autoCloseable;
    private CapteurTypeDoctorServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new CapteurTypeDoctorServiceImpl(repository);
    }
