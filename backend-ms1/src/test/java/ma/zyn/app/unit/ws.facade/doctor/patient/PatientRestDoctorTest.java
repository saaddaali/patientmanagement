package ma.zyn.app.unit.ws.facade.doctor.patient;

import ma.zyn.app.bean.core.patient.Patient;
import ma.zyn.app.service.impl.doctor.patient.PatientDoctorServiceImpl;
import ma.zyn.app.ws.facade.doctor.patient.PatientRestDoctor;
...
public class PatientRestDoctorTest {

    private MockMvc mockMvc;

    @Mock
    private PatientDoctorServiceImpl service;
    @Mock
    private PatientConverter converter;

    @InjectMocks
    private PatientRestDoctor controller;
