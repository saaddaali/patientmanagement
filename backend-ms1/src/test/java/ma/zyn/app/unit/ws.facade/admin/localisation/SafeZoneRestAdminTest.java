...
import ma.zyn.app.service.impl.admin.localisation.SafeZoneAdminServiceImpl;
import ma.zyn.app.ws.facade.admin.localisation.SafeZoneRestAdmin;
...
public class SafeZoneRestAdminTest {

    private MockMvc mockMvc;

    @Mock
    private SafeZoneAdminServiceImpl service;
    @Mock
    private SafeZoneConverter converter;

    @InjectMocks
    private SafeZoneRestAdmin controller;
