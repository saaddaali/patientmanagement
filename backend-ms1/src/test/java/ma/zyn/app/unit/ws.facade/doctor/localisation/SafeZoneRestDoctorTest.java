...
import ma.zyn.app.ws.facade.doctor.localisation.SafeZoneRestDoctor;
...
public class SafeZoneRestDoctorTest {

    private MockMvc mockMvc;

    @Mock
    private SafeZoneDoctorServiceImpl service;
    @Mock
    private SafeZoneConverter converter;

    @InjectMocks
    private SafeZoneRestDoctor controller;
