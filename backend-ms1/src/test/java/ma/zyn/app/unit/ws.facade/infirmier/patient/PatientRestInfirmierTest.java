...
public class PatientRestInfirmierTest {

    private MockMvc mockMvc;

    @Mock
    private PatientInfirmierServiceImpl service;
    @Mock
    private PatientConverter converter;

    @InjectMocks
    private PatientRestInfirmier controller;
