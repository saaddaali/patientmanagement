package ma.zyn.app.unit.service.impl.admin.sensor;
...
@SpringBootTest
class CapteurAdminServiceImplTest {

    @Mock
    private CapteurDao repository;
    private AutoCloseable autoCloseable;
    private CapteurAdminServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new CapteurAdminServiceImpl(repository);
    }
