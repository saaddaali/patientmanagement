package ma.zyn.app.unit.service.impl.infirmier.healthcare;

import ma.zyn.app.bean.core.healthcare.InfirmierPatient;
import ma.zyn.app.dao.facade.core.healthcare.InfirmierPatientDao;
import ma.zyn.app.service.impl.infirmier.healthcare.InfirmierPatientInfirmierServiceImpl;
...
@SpringBootTest
class InfirmierPatientInfirmierServiceImplTest {

    @Mock
    private InfirmierPatientDao repository;
    private AutoCloseable autoCloseable;
    private InfirmierPatientInfirmierServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new InfirmierPatientInfirmierServiceImpl(repository);
    }
