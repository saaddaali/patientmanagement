...
import ma.zyn.app.ws.facade.infirmier.localisation.LocalisationRestInfirmier;
...
public class LocalisationRestInfirmierTest {

    private MockMvc mockMvc;

    @Mock
    private LocalisationInfirmierServiceImpl service;
    @Mock
    private LocalisationConverter converter;

    @InjectMocks
    private LocalisationRestInfirmier controller;
