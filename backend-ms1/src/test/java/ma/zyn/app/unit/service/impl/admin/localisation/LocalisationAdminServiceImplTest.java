package ma.zyn.app.unit.service.impl.admin.localisation;
...
@SpringBootTest
class LocalisationAdminServiceImplTest {

    @Mock
    private LocalisationDao repository;
    private AutoCloseable autoCloseable;
    private LocalisationAdminServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new LocalisationAdminServiceImpl(repository);
    }
