package ma.zyn.app.unit.ws.facade.admin.localisation;

import ma.zyn.app.bean.core.localisation.Localisation;
import ma.zyn.app.service.impl.admin.localisation.LocalisationAdminServiceImpl;
import ma.zyn.app.ws.facade.admin.localisation.LocalisationRestAdmin;
...
public class LocalisationRestAdminTest {

    private MockMvc mockMvc;

    @Mock
    private LocalisationAdminServiceImpl service;
    @Mock
    private LocalisationConverter converter;

    @InjectMocks
    private LocalisationRestAdmin controller;
