...
import ma.zyn.app.config.audit.AuditEntity;
import ma.zyn.app.config.audit.Log;
import ma.zyn.app.config.bean.BusinessObject;
import ma.zyn.app.config.bean.EnumBean;
