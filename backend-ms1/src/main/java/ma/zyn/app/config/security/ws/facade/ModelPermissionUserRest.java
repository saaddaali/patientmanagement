...
import ma.zyn.app.config.controller.AbstractController;
import ma.zyn.app.config.dto.FileTempDto;
import ma.zyn.app.config.security.bean.ModelPermissionUser;
import ma.zyn.app.config.security.dao.criteria.core.ModelPermissionUserCriteria;
import ma.zyn.app.config.security.service.facade.ModelPermissionUserService;
import ma.zyn.app.config.security.ws.converter.ModelPermissionUserConverter;
import ma.zyn.app.config.security.ws.dto.ModelPermissionUserDto;
