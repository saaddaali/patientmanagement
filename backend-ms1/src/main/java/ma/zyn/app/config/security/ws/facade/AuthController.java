package ma.zyn.app.config.security.ws.facade;

import jakarta.validation.Valid;

import ma.zyn.app.config.security.bean.User;
import ma.zyn.app.config.security.common.SecurityParams;
import ma.zyn.app.config.security.dao.facade.core.RoleDao;
import ma.zyn.app.config.security.payload.request.ActivationRequest;
import ma.zyn.app.config.security.service.facade.UserService;
import ma.zyn.app.config.security.ws.dto.UserDto;
import ma.zyn.app.config.security.ws.converter.UserConverter;

import ma.zyn.app.config.security.jwt.JwtUtils;
import ma.zyn.app.config.security.payload.request.LoginRequest;
import ma.zyn.app.config.security.payload.response.JwtResponse;

import ma.zyn.app.config.transverse.emailling.EmailRequest;
import ma.zyn.app.config.transverse.emailling.EmailService;

import ma.zyn.app.config.security.common.AuthoritiesConstants;

import ma.zyn.app.config.security.service.facade.LoginAttemptService;
...
public class AuthController {
    ...
    public ResponseEntity<Map<String, String>> registerDoctor(@RequestBody UserDto userDto) {
        return register(userDto, AuthoritiesConstants.DOCTOR);
    }
    @PostMapping("register/infirmier")
    public ResponseEntity<Map<String, String>> registerInfirmier(@RequestBody UserDto userDto) {
        return register(userDto, AuthoritiesConstants.INFIRMIER);
    }
