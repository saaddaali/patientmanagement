package ma.zyn.app.config.controller;

import jakarta.servlet.http.HttpServletRequest;
import ma.zyn.app.config.bean.BaseEntity;
import ma.zyn.app.config.converter.AbstractConverter;
import ma.zyn.app.config.criteria.BaseCriteria;
import ma.zyn.app.config.dto.BaseDto;
import ma.zyn.app.config.dto.FileTempDto;
import ma.zyn.app.config.exception.BusinessRuleException;
import ma.zyn.app.config.exception.GlobalException;
import ma.zyn.app.config.export.ExportModel;
import ma.zyn.app.config.service.IService;
import ma.zyn.app.config.util.*;
