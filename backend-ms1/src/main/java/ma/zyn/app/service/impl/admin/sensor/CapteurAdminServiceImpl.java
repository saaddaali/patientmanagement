...
import java.util.List;
@Service
public class CapteurAdminServiceImpl implements CapteurAdminService {
    ...
    public void findOrSaveAssociatedObject(Capteur t){
        if( t != null) {
            t.setCapteurType(capteurTypeService.findOrSave(t.getCapteurType()));
        }
    }
    ...
    @Autowired
    private CapteurTypeAdminService capteurTypeService ;

    public CapteurAdminServiceImpl(CapteurDao dao) {
        this.dao = dao;
    }
