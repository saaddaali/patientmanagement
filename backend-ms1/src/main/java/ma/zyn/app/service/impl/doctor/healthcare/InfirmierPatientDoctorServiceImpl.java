package ma.zyn.app.service.impl.doctor.healthcare;
...
@Service
public class InfirmierPatientDoctorServiceImpl implements InfirmierPatientDoctorService {
    ...
    public InfirmierPatient create(InfirmierPatient t) {
        if (t.getInfirmier() != null) {
            t.getInfirmier().setId(null);
            t.setInfirmier(infirmierService.create(t.getInfirmier()));
        }
    ...
    @Autowired
    private PatientDoctorService patientService ;

    public InfirmierPatientDoctorServiceImpl(InfirmierPatientDao dao) {
        this.dao = dao;
    }
