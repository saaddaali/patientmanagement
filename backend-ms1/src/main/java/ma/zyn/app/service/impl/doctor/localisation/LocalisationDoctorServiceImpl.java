package ma.zyn.app.service.impl.doctor.localisation;
...
import ma.zyn.app.service.facade.doctor.localisation.LocalisationDoctorService;
...
@Service
public class LocalisationDoctorServiceImpl implements LocalisationDoctorService {
    ...
    @Autowired
    private CapteurDoctorService capteurService ;
    @Autowired
    private PatientDoctorService patientService ;

    public LocalisationDoctorServiceImpl(LocalisationDao dao) {
        this.dao = dao;
    }
