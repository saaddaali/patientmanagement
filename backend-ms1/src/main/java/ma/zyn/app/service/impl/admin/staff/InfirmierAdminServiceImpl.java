package ma.zyn.app.service.impl.admin.staff;
...
@Service
public class InfirmierAdminServiceImpl implements InfirmierAdminService {
    ...
    public void findOrSaveAssociatedObject(Infirmier t){
        if( t != null) {
            t.setSpecialization(specializationService.findOrSave(t.getSpecialization()));
        }
    }
    ...
    @Autowired
    private SpecializationAdminService specializationService ;

    public InfirmierAdminServiceImpl(InfirmierDao dao) {
        this.dao = dao;
    }
