...
public class PatientInfirmierServiceImpl implements PatientInfirmierService {
    ...
    @Autowired
    private InfirmierPatientInfirmierService infirmierPatientService ;
    @Autowired
    private GenderInfirmierService genderService ;
    @Autowired
    private DoctorInfirmierService doctorService ;
    @Autowired
    private WarningPatientInfirmierService warningPatientService ;
    @Autowired
    private WarningTypeInfirmierService warningTypeService ;

    public PatientInfirmierServiceImpl(PatientDao dao) {
        this.dao = dao;
    }
