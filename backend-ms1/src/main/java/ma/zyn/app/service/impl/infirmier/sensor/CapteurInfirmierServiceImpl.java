...
import java.util.List;
@Service
public class CapteurInfirmierServiceImpl implements CapteurInfirmierService {
    ...
    @Autowired
    private CapteurTypeInfirmierService capteurTypeService ;

    public CapteurInfirmierServiceImpl(CapteurDao dao) {
        this.dao = dao;
    }
