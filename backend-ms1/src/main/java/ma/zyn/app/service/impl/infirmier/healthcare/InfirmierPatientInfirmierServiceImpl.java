package ma.zyn.app.service.impl.infirmier.healthcare;
...
import java.util.List;
@Service
public class InfirmierPatientInfirmierServiceImpl implements InfirmierPatientInfirmierService {
    ...
    @Autowired
    private InfirmierInfirmierService infirmierService ;
    @Autowired
    private PatientInfirmierService patientService ;

    public InfirmierPatientInfirmierServiceImpl(InfirmierPatientDao dao) {
        this.dao = dao;
    }
