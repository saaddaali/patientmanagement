...
public class AppApplication {
    ...
    private static void addPermission(List<ModelPermission> modelPermissions) {
        ...
        modelPermissions.add(new ModelPermission("Localisation"));
        modelPermissions.add(new ModelPermission("Patient"));
        modelPermissions.add(new ModelPermission("SafeZone"));
        modelPermissions.add(new ModelPermission("CapteurType"));
        modelPermissions.add(new ModelPermission("Capteur"));
