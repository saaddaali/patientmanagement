package  ma.zyn.app.ws.facade.infirmier.warning;
...
@RestController
@RequestMapping("/api/infirmier/warningPatient/")
public class WarningPatientRestInfirmier {
    ...
    public List<WarningPatientDto> findByPatientId(@PathVariable Long id){
   ...
   public WarningPatientRestInfirmier(WarningPatientInfirmierService service, WarningPatientConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final WarningPatientInfirmierService service;
