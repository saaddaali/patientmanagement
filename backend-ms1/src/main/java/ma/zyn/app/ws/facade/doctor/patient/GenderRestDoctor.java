package ma.zyn.app.ws.facade.doctor.patient;
...
@RestController
@RequestMapping("/api/doctor/gender/")
public class GenderRestDoctor {
   ...
   public GenderRestDoctor(GenderAdminService service, GenderConverter converter){
