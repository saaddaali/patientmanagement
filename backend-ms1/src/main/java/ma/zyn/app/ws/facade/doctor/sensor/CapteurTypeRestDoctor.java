...
@RestController
@RequestMapping("/api/doctorgit/capteurType/")
public class CapteurTypeRestDoctor {
   ...
   public CapteurTypeRestDoctor(CapteurTypeAdminService service, CapteurTypeConverter converter){
