...
@RestController
@RequestMapping("/api/admin/safeZone/")
public class SafeZoneRestAdmin {
   ...
   public SafeZoneRestAdmin(SafeZoneAdminService service, SafeZoneConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final SafeZoneAdminService service;
