...
public class LocalisationRestInfirmier {
   ...
   public LocalisationRestInfirmier(LocalisationInfirmierService service, LocalisationConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final LocalisationInfirmierService service;
