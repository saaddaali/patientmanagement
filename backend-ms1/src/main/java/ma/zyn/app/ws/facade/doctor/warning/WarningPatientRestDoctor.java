package  ma.zyn.app.ws.facade.doctor.warning;
...
@RestController
@RequestMapping("/api/doctor/warningPatient/")
public class WarningPatientRestDoctor {
   ...
   public WarningPatientRestDoctor(WarningPatientDoctorService service, WarningPatientConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final WarningPatientDoctorService service;
