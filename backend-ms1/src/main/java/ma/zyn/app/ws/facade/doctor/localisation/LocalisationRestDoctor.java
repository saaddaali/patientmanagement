...
@RestController
@RequestMapping("/api/doctor/localisation/")
public class LocalisationRestDoctor {
   ...
   public LocalisationRestDoctor(LocalisationDoctorService service, LocalisationConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final LocalisationDoctorService service;
